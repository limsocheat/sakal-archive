                    ...
                    <div class="px-4 py-5 bg-white sm:p-6">
                        <div class="grid grid-cols-6 gap-x-6">
                            ...
                            <div class="col-span-12 sm:col-span-6">
                                <x-form-input name="phone" :label="__('Phone Number')">
                                </x-form-input>
                            </div>

                            <div class="col-span-12 sm:col-span-6">
                                <x-form-input name="email" :label="__('Email Address')" type="email">
                                </x-form-input>
                            </div>
                    ...
                    <div class="px-4 py-5 bg-white space-y-6 sm:p-6">
                        ...
                        <fieldset>
                            <div>
                                ...
                                <p class="text-sm text-gray-500">These are delivered via SMS to
                                    your
                                    mobile phone.</p>
                            </div>
                            <div class="mt-4 space-y-4">
